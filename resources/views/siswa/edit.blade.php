                    ...
                    <div class="panel-body">
                        <form action="{{ route('siswa.update',$pegawai->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group {{ $errors->has('nama') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="tempat" value="{{$pegawai->tempat}}" class="form-control" required> @if ($errors->has('nama'))
                                <span class="help-block">
                                <strong>{{ $errors->first('nama') }}</strong>
                            </span> @endif
                            </div>
                            <div class="form-group {{ $errors->has('nama') ? ' has-error' : '' }}">
                                ...
                                <input type="date" name="tanggallahir" value="{{$pegawai->tanggallahir}}" class="form-control" required> @if ($errors->has('nama'))
                                <span class="help-block">
                                <strong>{{ $errors->first('nama') }}</strong>
                            </span> @endif
                            </div>
                            <div class="form-group {{ $errors->has('nama') ? ' has-error' : '' }}">
                                ...
                                <input type="number" name="nohp" value="{{$pegawai->nohp}}" class="form-control" required> @if ($errors->has('nama'))
                                <span class="help-block">
                                <strong>{{ $errors->first('nama') }}</strong>
                            </span> @endif
                            </div>
